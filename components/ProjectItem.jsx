...
const ProjectItem = ({title, backgroundImg, skills, projectUrl}) => {
  return (
   <div className=" relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400 rounded-xl p-4 group hover:bg-gradient-to-r from-[#44a3ac] to-[#8fb8ba]">
   ...
   <div className="hidden group-hover:block absolute bottom-[50%] right-[50%] translate-x-[50%] translate-y-[50%]">
     ...
     <Link href={projectUrl}>
       <p className="text-center rounded-lg bg-white text-gray-700 font-bold lg:text-lg text-md cursor-pointer">More Info</p>
     </Link> 
   </div> 
 </div>
  );
